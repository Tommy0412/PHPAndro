...
.card { @apply bg-white/80 dark:bg-gray-800/70 backdrop-blur rounded-2xl shadow-lg p-4; }
</style>
</head>
...
document.getElementById('downloadBtn').onclick = () => {
  const blob = new Blob([lastOutput||output.innerText], {type:'text/plain'});
  const a = document.createElement('a'); a.href = URL.createObjectURL(blob); a.download='php-output.txt'; a.click();
}
document.getElementById('clearBtn').onclick = () => { output.innerHTML='Cleared.'; }
